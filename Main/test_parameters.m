...
file = fopen('parameter.txt', 'a');
for a1=0.1:0.1:1
    for a2=0.1:0.05:0.5
        for a3=0.001:0.001:0.005
            for a4=0.85:0.05:1.2
                for b1=2:0.1:4
                    for b2=0.1:0.05:0.5
                        for b3=0.05:0.05:0.3
                            for i=1:10
                                residue=s-xt-xn;
                                k=mod(i,2);
                            ...
                            fprintf(file,'%0.5f,%0.5f,%0.5f,%0.5f,%0.5f,%0.5f,%0.5f,%0.5f,%0.5f\n',a1,a2,a3,a4,b1,b2,b3,repaire_psnr,repaire_mse);
                        end
                    end
                end
            end
